...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.48.tar.xz'
...
download_file 'https://github.com/vim/vim/archive/refs/tags/v9.2.1011.tar.gz' 'vim-9.2.1011.tar.gz'
...
download_file 'https://github.com/systemd/systemd/archive/v261.2/systemd-261.2.tar.gz'
