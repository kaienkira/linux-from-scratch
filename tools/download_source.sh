...
download_file 'https://ftp.gnu.org/gnu/binutils/binutils-2.46.1.tar.xz'
...
download_file 'https://ftp.gnu.org/gnu/gcc/gcc-16.1.0/gcc-16.1.0.tar.xz'
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/aa/gcc-16.1.0-patches-3.tar.xz' 'gcc_patch-16.1.0-3.tar.xz'
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.39.tar.xz'
download_file 'https://ftp.gnu.org/gnu/glibc/glibc-2.43.tar.xz'
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/79/glibc-2.43-patches-3.tar.xz' 'glibc_patch-2.43-3.tar.xz'
...
download_file 'https://github.com/vim/vim/archive/refs/tags/v9.2.0735.tar.gz' 'vim-9.2.0735.tar.gz'
...
download_file 'https://github.com/systemd/systemd/archive/v261.1/systemd-261.1.tar.gz'
