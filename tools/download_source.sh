...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.35.tar.xz'
...
download_file 'https://github.com/vim/vim/archive/refs/tags/v9.2.0612.tar.gz' 'vim-9.2.0612.tar.gz'
