...
download_file 'https://github.com/mesonbuild/meson/releases/download/1.12.0/meson-1.12.0.tar.gz'
download_file 'https://ftp.gnu.org/gnu/texinfo/texinfo-7.3.tar.xz'
download_file 'https://www.kernel.org/pub/linux/utils/util-linux/v2.42/util-linux-2.42.3.tar.xz'
