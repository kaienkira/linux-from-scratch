...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.45.tar.xz'
...
download_file 'https://github.com/libexpat/libexpat/releases/download/R_2_8_3/expat-2.8.3.tar.xz'
...
download_file 'https://github.com/vim/vim/archive/refs/tags/v9.2.0849.tar.gz' 'vim-9.2.0849.tar.gz'
