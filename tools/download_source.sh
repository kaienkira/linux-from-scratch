...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.27.tar.xz'
...
download_file 'https://www.python.org/ftp/python/3.14.4/Python-3.14.4.tar.xz'
