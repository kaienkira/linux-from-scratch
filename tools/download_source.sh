...
download_file 'https://ftp.gnu.org/gnu/binutils/binutils-2.47.tar.xz'
...
download_file 'https://ftp.gnu.org/gnu/gcc/gcc-16.2.0/gcc-16.2.0.tar.xz'
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/65/gcc-16.2.0-patches-1.tar.xz' 'gcc_patch-16.2.0-1.tar.xz'
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.53.tar.xz'
download_file 'https://ftp.gnu.org/gnu/glibc/glibc-2.44.tar.xz'
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/ca/glibc-2.44-patches-1.tar.xz' 'glibc_patch-2.44-1.tar.xz'
...
download_file 'https://ftp.gnu.org/gnu/gawk/gawk-5.4.1.tar.xz'
download_file 'https://ftp.gnu.org/gnu/grep/grep-3.12.tar.xz'
download_file 'https://ftp.gnu.org/gnu/gzip/gzip-1.15.tar.xz'
download_file 'https://ftp.gnu.org/gnu/make/make-4.4.1.tar.gz'
download_file 'https://ftp.gnu.org/gnu/patch/patch-2.8.tar.xz'
download_file 'https://ftp.gnu.org/gnu/sed/sed-4.10.tar.xz'
download_file 'https://ftp.gnu.org/gnu/tar/tar-1.35.tar.xz'
download_file 'https://github.com/tukaani-project/xz/releases/download/v5.8.4/xz-5.8.4.tar.xz'
...
download_file 'https://pypi.org/packages/source/f/flit-core/flit_core-4.0.2.tar.gz'
download_file 'https://pypi.org/packages/source/p/packaging/packaging-26.3.tar.gz'
download_file 'https://pypi.org/packages/source/w/wheel/wheel-0.48.0.tar.gz'
download_file 'https://pypi.org/packages/source/s/setuptools/setuptools-84.0.0.tar.gz'
...
download_file 'https://github.com/mesonbuild/meson/releases/download/1.12.1/meson-1.12.1.tar.gz'
download_file 'https://ftp.gnu.org/gnu/texinfo/texinfo-7.3.tar.xz'
download_file 'https://www.kernel.org/pub/linux/utils/util-linux/v2.42/util-linux-2.42.4.tar.xz'
...
download_file 'https://data.iana.org/time-zones/releases/tzdata2026d.tar.gz'
...
download_file 'https://www.kernel.org/pub/linux/libs/security/linux-privs/libcap2/libcap-2.78.tar.xz'
download_file 'https://github.com/besser82/libxcrypt/releases/download/v4.5.2/libxcrypt-4.5.2.tar.xz'
download_file 'https://github.com/shadow-maint/shadow/releases/download/4.20.2/shadow-4.20.2.tar.xz'
download_file 'https://sourceforge.net/projects/psmisc/files/psmisc/psmisc-23.7.tar.xz'
download_file 'https://ftp.gnu.org/gnu/libtool/libtool-2.6.2.tar.xz'
download_file 'https://ftp.gnu.org/gnu/gdbm/gdbm-1.26.tar.gz'
download_file 'https://ftp.gnu.org/gnu/gperf/gperf-3.3.tar.gz'
download_file 'https://github.com/libexpat/libexpat/releases/download/R_2_8_5/expat-2.8.5.tar.xz'
download_file 'https://www.greenwoodsoftware.com/less/less-710.tar.gz'
...
download_file 'https://github.com/vim/vim/archive/refs/tags/v9.2.1046.tar.gz' 'vim-9.2.1046.tar.gz'
...
download_file 'https://github.com/systemd/systemd/archive/v261.3/systemd-261.3.tar.gz'
...
download_file 'https://curl.se/download/curl-8.22.0.tar.xz'
