...
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/d5/gcc-16.1.0-patches-1.tar.xz' 'gcc_patch-16.1.0-1.tar.xz'
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.32.tar.xz'
download_file 'https://ftp.gnu.org/gnu/glibc/glibc-2.43.tar.xz'
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/b4/glibc-2.43-patches-2.tar.xz' 'glibc_patch-2.43-2.tar.xz'
