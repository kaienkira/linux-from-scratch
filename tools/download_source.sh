...
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.44.tar.xz'
...
download_file 'https://pypi.org/packages/source/s/setuptools/setuptools-83.0.0.tar.gz'
...
download_file 'https://github.com/mesonbuild/meson/releases/download/1.11.1/meson-1.11.1.tar.gz'
