...
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/fb/gcc-16.1.0-patches-2.tar.xz' 'gcc_patch-16.1.0-2.tar.xz'
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.33.tar.xz'
...
download_file 'https://www.python.org/ftp/python/3.14.5/Python-3.14.5.tar.xz'
...
download_file 'https://www.kernel.org/pub/linux/utils/util-linux/v2.42/util-linux-2.42.1.tar.xz'
...
download_file 'https://github.com/openssl/openssl/releases/download/openssl-3.6.2/openssl-3.6.2.tar.gz'
...
download_file 'https://curl.se/download/curl-8.20.0.tar.xz'
