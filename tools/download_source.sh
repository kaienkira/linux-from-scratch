...
download_patch 'https://mirrors.tuna.tsinghua.edu.cn/gentoo/distfiles/8b/gcc-15.2.0-patches-5.tar.xz' 'gcc_patch-15.2.0-5.tar.xz'
download_file 'https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.18.23.tar.xz'
